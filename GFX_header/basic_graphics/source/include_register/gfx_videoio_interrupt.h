...
#define GFXINT_VIDEOIO_INTR1_BIT_FRAMEGEN1_PRIMSYNC_ON 0x00004000u /* 14 */
/* FRAMEGEN1_PRIMSYNC_OFF: Synchronization status deactivated (Display Engine 1, Primary Stream). */
#define GFXINT_VIDEOIO_INTR1_BIT_FRAMEGEN1_PRIMSYNC_OFF 0x00008000u /* 15 */
/* FRAMEGEN1_SECSYNC_ON: Synchronization status activated (Display Engine 1, Secondary Stream). */
#define GFXINT_VIDEOIO_INTR1_BIT_FRAMEGEN1_SECSYNC_ON 0x00010000u /* 16 */
/* FRAMEGEN1_SECSYNC_OFF: Synchronization status deactivated (Display Engine 1, Secondary Stream). */
#define GFXINT_VIDEOIO_INTR1_BIT_FRAMEGEN1_SECSYNC_OFF 0x00020000u /* 17 */
/* DISENGCFG_SHDLOAD1: Shadow load (Display Engine 1). */
#define GFXINT_VIDEOIO_INTR1_BIT_DISENGCFG_SHDLOAD1 0x00040000u /* 18 */
/* DISENGCFG_FRAMECOMPLETE1: Frame complete (Display Engine 1). */
#define GFXINT_VIDEOIO_INTR1_BIT_DISENGCFG_FRAMECOMPLETE1 0x00080000u /* 19 */
/* DISENGCFG_SEQCOMPLETE1: Sequence complete (Display Engine 1). */
#define GFXINT_VIDEOIO_INTR1_BIT_DISENGCFG_SEQCOMPLETE1 0x00100000u /* 20 */
/* FRAMEGEN1_INT0: Programmable interrupt 0 (Display Engine 1, Frame Generator). */
#define GFXINT_VIDEOIO_INTR1_BIT_FRAMEGEN1_INT0 0x00200000u /* 21 */
/* FRAMEGEN1_INT1: Programmable interrupt 1 (Display Engine 1, Frame Generator). */
#define GFXINT_VIDEOIO_INTR1_BIT_FRAMEGEN1_INT1 0x00400000u /* 22 */
/* FRAMEGEN1_INT2: Programmable interrupt 2 (Display Engine 1, Frame Generator). */
#define GFXINT_VIDEOIO_INTR1_BIT_FRAMEGEN1_INT2 0x00800000u /* 23 */
/* FRAMEGEN1_INT3: Programmable interrupt 3 (Display Engine 1, Frame Generator). */
#define GFXINT_VIDEOIO_INTR1_BIT_FRAMEGEN1_INT3 0x01000000u /* 24 */
/* SIG1_SHDLOAD: Shadow load (Display Engine 1, Signature Unit). */
#define GFXINT_VIDEOIO_INTR1_BIT_SIG1_SHDLOAD 0x02000000u /* 25 */
/* SIG1_VALID: Measurement valid (Display Engine 1, Signature Unit) */
#define GFXINT_VIDEOIO_INTR1_BIT_SIG1_VALID 0x04000000u /* 26 */
/* SIG1_ERROR: Error condition (Display Engine 1, Signature Unit) */
#define GFXINT_VIDEOIO_INTR1_BIT_SIG1_ERROR 0x08000000u /* 27 */
