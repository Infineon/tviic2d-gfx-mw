...
#define GFXREG_VIDEOIOCFG_INTR_VIDEOIO1_INTR_VIDEOIO1_FMASK 0xfffffffU
#define GFXREG_VIDEOIOCFG_INTR_VIDEOIO1_SETM_INTR_VIDEOIO1(val) (((CYGFX_U32)(val) & 0xfffffffUL) )
#define GFXREG_VIDEOIOCFG_INTR_VIDEOIO1_SET_INTR_VIDEOIO1(val) (((CYGFX_U32)(val) ) | GCCGFX_GEN_ASSERT_FIELD_ACCESS(val, 0xfffffffUL, __FILE__, __LINE__))
#define GFXREG_VIDEOIOCFG_INTR_VIDEOIO1_GET_INTR_VIDEOIO1(val) (((CYGFX_U32)(val) ) & 0xfffffffUL)
#define GFXREG_VIDEOIOCFG_SETM_INTR_VIDEOIO1(s,val) ( (s)->intr_videoio1 = ((s)->intr_videoio1 & ~0xfffffffUL) | (((CYGFX_U32)(val) ) & 0xfffffffUL) )
#define GFXREG_VIDEOIOCFG_SET_INTR_VIDEOIO1(s,val)  ( (s)->intr_videoio1 = (((s)->intr_videoio1 & ~0xfffffffUL) | ((CYGFX_U32)(val) ) ) | GCCGFX_GEN_ASSERT_FIELD_ACCESS(val, 0xfffffffUL, __FILE__, __LINE__) )
#define GFXREG_VIDEOIOCFG_GET_INTR_VIDEOIO1(s) ((((s)->intr_videoio1) ) & 0xfffffffUL)
...
#define GFXREG_VIDEOIOCFG_INTR_VIDEOIO1_SET_INTR_VIDEOIO1_SET_FMASK 0xfffffffU
#define GFXREG_VIDEOIOCFG_INTR_VIDEOIO1_SET_SETM_INTR_VIDEOIO1_SET(val) (((CYGFX_U32)(val) & 0xfffffffUL) )
#define GFXREG_VIDEOIOCFG_INTR_VIDEOIO1_SET_SET_INTR_VIDEOIO1_SET(val) (((CYGFX_U32)(val) ) | GCCGFX_GEN_ASSERT_FIELD_ACCESS(val, 0xfffffffUL, __FILE__, __LINE__))
#define GFXREG_VIDEOIOCFG_SETM_INTR_VIDEOIO1_SET(s,val) ( (s)->intr_videoio1_set = ((s)->intr_videoio1_set & ~0xfffffffUL) | (((CYGFX_U32)(val) ) & 0xfffffffUL) )
#define GFXREG_VIDEOIOCFG_SET_INTR_VIDEOIO1_SET(s,val)  ( (s)->intr_videoio1_set = (((s)->intr_videoio1_set & ~0xfffffffUL) | ((CYGFX_U32)(val) ) ) | GCCGFX_GEN_ASSERT_FIELD_ACCESS(val, 0xfffffffUL, __FILE__, __LINE__) )
...
#define GFXREG_VIDEOIOCFG_INTR_VIDEOIO1_MASK_INTR_VIDEOIO1_MASK_FMASK 0xfffffffU
#define GFXREG_VIDEOIOCFG_INTR_VIDEOIO1_MASK_SETM_INTR_VIDEOIO1_MASK(val) (((CYGFX_U32)(val) & 0xfffffffUL) )
#define GFXREG_VIDEOIOCFG_INTR_VIDEOIO1_MASK_SET_INTR_VIDEOIO1_MASK(val) (((CYGFX_U32)(val) ) | GCCGFX_GEN_ASSERT_FIELD_ACCESS(val, 0xfffffffUL, __FILE__, __LINE__))
#define GFXREG_VIDEOIOCFG_INTR_VIDEOIO1_MASK_GET_INTR_VIDEOIO1_MASK(val) (((CYGFX_U32)(val) ) & 0xfffffffUL)
#define GFXREG_VIDEOIOCFG_SETM_INTR_VIDEOIO1_MASK(s,val) ( (s)->intr_videoio1_mask = ((s)->intr_videoio1_mask & ~0xfffffffUL) | (((CYGFX_U32)(val) ) & 0xfffffffUL) )
#define GFXREG_VIDEOIOCFG_SET_INTR_VIDEOIO1_MASK(s,val)  ( (s)->intr_videoio1_mask = (((s)->intr_videoio1_mask & ~0xfffffffUL) | ((CYGFX_U32)(val) ) ) | GCCGFX_GEN_ASSERT_FIELD_ACCESS(val, 0xfffffffUL, __FILE__, __LINE__) )
#define GFXREG_VIDEOIOCFG_GET_INTR_VIDEOIO1_MASK(s) ((((s)->intr_videoio1_mask) ) & 0xfffffffUL)
...
#define GFXREG_VIDEOIOCFG_INTR_VIDEOIO1_MASKED_INTR_VIDEOIO1_MASKED_FMASK 0xfffffffU
#define GFXREG_VIDEOIOCFG_INTR_VIDEOIO1_MASKED_GET_INTR_VIDEOIO1_MASKED(val) (((CYGFX_U32)(val) ) & 0xfffffffUL)
#define GFXREG_VIDEOIOCFG_GET_INTR_VIDEOIO1_MASKED(s) ((((s)->intr_videoio1_masked) ) & 0xfffffffUL)
...
/* INTR_VIDEOIO0_SAFETY: Interrupt Status register 0
   Bit mapping is same like in INTR_VIDEOIO0. */
...
/* INTR_VIDEOIO1_SAFETY: Interrupt Status register 1
   Bit mapping is same like in INTR_VIDEOIO1. */
...
#define GFXREG_VIDEOIOCFG_INTR_VIDEOIO1_SAFETY_INTR_VIDEOIO1_SAFETY_FMASK 0xfffffffU
#define GFXREG_VIDEOIOCFG_INTR_VIDEOIO1_SAFETY_SETM_INTR_VIDEOIO1_SAFETY(val) (((CYGFX_U32)(val) & 0xfffffffUL) )
#define GFXREG_VIDEOIOCFG_INTR_VIDEOIO1_SAFETY_SET_INTR_VIDEOIO1_SAFETY(val) (((CYGFX_U32)(val) ) | GCCGFX_GEN_ASSERT_FIELD_ACCESS(val, 0xfffffffUL, __FILE__, __LINE__))
#define GFXREG_VIDEOIOCFG_INTR_VIDEOIO1_SAFETY_GET_INTR_VIDEOIO1_SAFETY(val) (((CYGFX_U32)(val) ) & 0xfffffffUL)
#define GFXREG_VIDEOIOCFG_SETM_INTR_VIDEOIO1_SAFETY(s,val) ( (s)->intr_videoio1_safety = ((s)->intr_videoio1_safety & ~0xfffffffUL) | (((CYGFX_U32)(val) ) & 0xfffffffUL) )
#define GFXREG_VIDEOIOCFG_SET_INTR_VIDEOIO1_SAFETY(s,val)  ( (s)->intr_videoio1_safety = (((s)->intr_videoio1_safety & ~0xfffffffUL) | ((CYGFX_U32)(val) ) ) | GCCGFX_GEN_ASSERT_FIELD_ACCESS(val, 0xfffffffUL, __FILE__, __LINE__) )
#define GFXREG_VIDEOIOCFG_GET_INTR_VIDEOIO1_SAFETY(s) ((((s)->intr_videoio1_safety) ) & 0xfffffffUL)
...
#define GFXREG_VIDEOIOCFG_INTR_VIDEOIO1_SAFETY_SET_INTR_VIDEOIO1_SAFETY_SET_FMASK 0xfffffffU
#define GFXREG_VIDEOIOCFG_INTR_VIDEOIO1_SAFETY_SET_SETM_INTR_VIDEOIO1_SAFETY_SET(val) (((CYGFX_U32)(val) & 0xfffffffUL) )
#define GFXREG_VIDEOIOCFG_INTR_VIDEOIO1_SAFETY_SET_SET_INTR_VIDEOIO1_SAFETY_SET(val) (((CYGFX_U32)(val) ) | GCCGFX_GEN_ASSERT_FIELD_ACCESS(val, 0xfffffffUL, __FILE__, __LINE__))
#define GFXREG_VIDEOIOCFG_SETM_INTR_VIDEOIO1_SAFETY_SET(s,val) ( (s)->intr_videoio1_safety_set = ((s)->intr_videoio1_safety_set & ~0xfffffffUL) | (((CYGFX_U32)(val) ) & 0xfffffffUL) )
#define GFXREG_VIDEOIOCFG_SET_INTR_VIDEOIO1_SAFETY_SET(s,val)  ( (s)->intr_videoio1_safety_set = (((s)->intr_videoio1_safety_set & ~0xfffffffUL) | ((CYGFX_U32)(val) ) ) | GCCGFX_GEN_ASSERT_FIELD_ACCESS(val, 0xfffffffUL, __FILE__, __LINE__) )
...
#define GFXREG_VIDEOIOCFG_INTR_VIDEOIO1_SAFETY_MASK_INTR_VIDEOIO1_SAFETY_MASK_FMASK 0xfffffffU
#define GFXREG_VIDEOIOCFG_INTR_VIDEOIO1_SAFETY_MASK_SETM_INTR_VIDEOIO1_SAFETY_MASK(val) (((CYGFX_U32)(val) & 0xfffffffUL) )
#define GFXREG_VIDEOIOCFG_INTR_VIDEOIO1_SAFETY_MASK_SET_INTR_VIDEOIO1_SAFETY_MASK(val) (((CYGFX_U32)(val) ) | GCCGFX_GEN_ASSERT_FIELD_ACCESS(val, 0xfffffffUL, __FILE__, __LINE__))
#define GFXREG_VIDEOIOCFG_INTR_VIDEOIO1_SAFETY_MASK_GET_INTR_VIDEOIO1_SAFETY_MASK(val) (((CYGFX_U32)(val) ) & 0xfffffffUL)
#define GFXREG_VIDEOIOCFG_SETM_INTR_VIDEOIO1_SAFETY_MASK(s,val) ( (s)->intr_videoio1_safety_mask = ((s)->intr_videoio1_safety_mask & ~0xfffffffUL) | (((CYGFX_U32)(val) ) & 0xfffffffUL) )
#define GFXREG_VIDEOIOCFG_SET_INTR_VIDEOIO1_SAFETY_MASK(s,val)  ( (s)->intr_videoio1_safety_mask = (((s)->intr_videoio1_safety_mask & ~0xfffffffUL) | ((CYGFX_U32)(val) ) ) | GCCGFX_GEN_ASSERT_FIELD_ACCESS(val, 0xfffffffUL, __FILE__, __LINE__) )
#define GFXREG_VIDEOIOCFG_GET_INTR_VIDEOIO1_SAFETY_MASK(s) ((((s)->intr_videoio1_safety_mask) ) & 0xfffffffUL)
...
#define GFXREG_VIDEOIOCFG_INTR_VIDEOIO1_SAFETY_MASKED_INTR_VIDEOIO1_SAFETY_MASKED_FMASK 0xfffffffU
#define GFXREG_VIDEOIOCFG_INTR_VIDEOIO1_SAFETY_MASKED_GET_INTR_VIDEOIO1_SAFETY_MASKED(val) (((CYGFX_U32)(val) ) & 0xfffffffUL)
#define GFXREG_VIDEOIOCFG_GET_INTR_VIDEOIO1_SAFETY_MASKED(s) ((((s)->intr_videoio1_safety_masked) ) & 0xfffffffUL)
