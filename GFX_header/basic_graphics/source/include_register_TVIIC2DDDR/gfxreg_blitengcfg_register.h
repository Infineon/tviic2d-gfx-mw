...
/* CACHEINVALIDATIONSRC: Triggers invalidation of the GfxCache for FetchSrc with the next operation start. Operation can be any IBO or LBO fill, fetch or store. */
#define GFXREG_BLITENGCFG_SYNCCONTROL_CACHEINVALIDATIONSRC_FSHIFT 16U
#define GFXREG_BLITENGCFG_SYNCCONTROL_CACHEINVALIDATIONSRC_FMASK 0x1U
#define GFXREG_BLITENGCFG_SYNCCONTROL_SETM_CACHEINVALIDATIONSRC(val) (((CYGFX_U32)(val) & 0x1UL) << 16U)
#define GFXREG_BLITENGCFG_SYNCCONTROL_SET_CACHEINVALIDATIONSRC(val) (((CYGFX_U32)(val) << 16U) | GCCGFX_GEN_ASSERT_FIELD_ACCESS(val, 0x1UL, __FILE__, __LINE__))
#define GFXREG_BLITENGCFG_SETM_CACHEINVALIDATIONSRC(s,val) ( (s)->synccontrol = ((s)->synccontrol & ~0x10000UL) | (((CYGFX_U32)(val) << 16U) & 0x10000UL) )
#define GFXREG_BLITENGCFG_SET_CACHEINVALIDATIONSRC(s,val)  ( (s)->synccontrol = (((s)->synccontrol & ~0x10000UL) | ((CYGFX_U32)(val) << 16U) ) | GCCGFX_GEN_ASSERT_FIELD_ACCESS(val, 0x1UL, __FILE__, __LINE__) )
#define GFXREG_BLITENGCFG_SYNCCONTROL_CACHEINVALIDATIONSRC_RESET (none)U

/* CACHEINVALIDATIONDST: Triggers invalidation of the GfxCache for FetchDst with the next operation start. Operation can be any IBO or LBO fill, fetch or store. */
#define GFXREG_BLITENGCFG_SYNCCONTROL_CACHEINVALIDATIONDST_FSHIFT 17U
#define GFXREG_BLITENGCFG_SYNCCONTROL_CACHEINVALIDATIONDST_FMASK 0x1U
#define GFXREG_BLITENGCFG_SYNCCONTROL_SETM_CACHEINVALIDATIONDST(val) (((CYGFX_U32)(val) & 0x1UL) << 17U)
#define GFXREG_BLITENGCFG_SYNCCONTROL_SET_CACHEINVALIDATIONDST(val) (((CYGFX_U32)(val) << 17U) | GCCGFX_GEN_ASSERT_FIELD_ACCESS(val, 0x1UL, __FILE__, __LINE__))
#define GFXREG_BLITENGCFG_SETM_CACHEINVALIDATIONDST(s,val) ( (s)->synccontrol = ((s)->synccontrol & ~0x20000UL) | (((CYGFX_U32)(val) << 17U) & 0x20000UL) )
#define GFXREG_BLITENGCFG_SET_CACHEINVALIDATIONDST(s,val)  ( (s)->synccontrol = (((s)->synccontrol & ~0x20000UL) | ((CYGFX_U32)(val) << 17U) ) | GCCGFX_GEN_ASSERT_FIELD_ACCESS(val, 0x1UL, __FILE__, __LINE__) )
#define GFXREG_BLITENGCFG_SYNCCONTROL_CACHEINVALIDATIONDST_RESET (none)U

/* CACHEINVALIDATIONMASK: Triggers invalidation of the GfxCache for FetchMask with the next operation start. Operation can be any IBO or LBO fill, fetch or store. */
#define GFXREG_BLITENGCFG_SYNCCONTROL_CACHEINVALIDATIONMASK_FSHIFT 18U
#define GFXREG_BLITENGCFG_SYNCCONTROL_CACHEINVALIDATIONMASK_FMASK 0x1U
#define GFXREG_BLITENGCFG_SYNCCONTROL_SETM_CACHEINVALIDATIONMASK(val) (((CYGFX_U32)(val) & 0x1UL) << 18U)
#define GFXREG_BLITENGCFG_SYNCCONTROL_SET_CACHEINVALIDATIONMASK(val) (((CYGFX_U32)(val) << 18U) | GCCGFX_GEN_ASSERT_FIELD_ACCESS(val, 0x1UL, __FILE__, __LINE__))
#define GFXREG_BLITENGCFG_SETM_CACHEINVALIDATIONMASK(s,val) ( (s)->synccontrol = ((s)->synccontrol & ~0x40000UL) | (((CYGFX_U32)(val) << 18U) & 0x40000UL) )
#define GFXREG_BLITENGCFG_SET_CACHEINVALIDATIONMASK(s,val)  ( (s)->synccontrol = (((s)->synccontrol & ~0x40000UL) | ((CYGFX_U32)(val) << 18U) ) | GCCGFX_GEN_ASSERT_FIELD_ACCESS(val, 0x1UL, __FILE__, __LINE__) )
#define GFXREG_BLITENGCFG_SYNCCONTROL_CACHEINVALIDATIONMASK_RESET (none)U
...
#define GFXREG_BLITENGCFG_DESIGNATTRIBUTES0_SLICEHEIGHT_RESET (none)U
...
#define GFXREG_BLITENGCFG_DESIGNATTRIBUTES0_PROCESSINGPIPELINES_RESET (none)U
...
#define GFXREG_BLITENGCFG_DESIGNATTRIBUTES0_SLICEWIDTH_RESET (none)U
...
#define GFXREG_BLITENGCFG_DESIGNATTRIBUTES1_GPSCALERWIDTH_RESET (none)U
...
#define GFXREG_BLITENGCFG_PALETTE_PALETTEENTRY_RESET (none)U
