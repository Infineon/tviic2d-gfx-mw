...
/* CONSTANTCOLOR: 8-bit constant frame color components. */
...
/* CONSTANTCOLORLSBITS: LSBits for 10-bit constant frame color components (optional). */
#define GFXREG_CONSTFRAME_CONSTANTCOLORLSBITS 0x0000000cU
/* ENABLELSBITS: If enabled, the two least significant bits of 10-bit color components are taken from this register. */
#define GFXREG_CONSTFRAME_CONSTANTCOLORLSBITS_ENABLELSBITS_FSHIFT 0U
#define GFXREG_CONSTFRAME_CONSTANTCOLORLSBITS_ENABLELSBITS_FMASK 0x1U
#define GFXREG_CONSTFRAME_CONSTANTCOLORLSBITS_SETM_ENABLELSBITS(val) (((CYGFX_U32)(val) & 0x1UL) )
#define GFXREG_CONSTFRAME_CONSTANTCOLORLSBITS_SET_ENABLELSBITS(val) (((CYGFX_U32)(val) ) | GCCGFX_GEN_ASSERT_FIELD_ACCESS(val, 0x1UL, __FILE__, __LINE__))
#define GFXREG_CONSTFRAME_CONSTANTCOLORLSBITS_GET_ENABLELSBITS(val) (((CYGFX_U32)(val) ) & 0x1UL)
#define GFXREG_CONSTFRAME_SETM_ENABLELSBITS(s,val) ( (s)->constantcolorlsbits = ((s)->constantcolorlsbits & ~0x1UL) | (((CYGFX_U32)(val) ) & 0x1UL) )
#define GFXREG_CONSTFRAME_SET_ENABLELSBITS(s,val)  ( (s)->constantcolorlsbits = (((s)->constantcolorlsbits & ~0x1UL) | ((CYGFX_U32)(val) ) ) | GCCGFX_GEN_ASSERT_FIELD_ACCESS(val, 0x1UL, __FILE__, __LINE__) )
#define GFXREG_CONSTFRAME_GET_ENABLELSBITS(s) ((((s)->constantcolorlsbits) ) & 0x1UL)
#define GFXREG_CONSTFRAME_CONSTANTCOLORLSBITS_ENABLELSBITS_RESET 0U

/* CONSTANTBLUELSBITS: LSBits of 10-bit blue component. */
#define GFXREG_CONSTFRAME_CONSTANTCOLORLSBITS_CONSTANTBLUELSBITS_FSHIFT 8U
#define GFXREG_CONSTFRAME_CONSTANTCOLORLSBITS_CONSTANTBLUELSBITS_FMASK 0x3U
#define GFXREG_CONSTFRAME_CONSTANTCOLORLSBITS_SETM_CONSTANTBLUELSBITS(val) (((CYGFX_U32)(val) & 0x3UL) << 8U)
#define GFXREG_CONSTFRAME_CONSTANTCOLORLSBITS_SET_CONSTANTBLUELSBITS(val) (((CYGFX_U32)(val) << 8U) | GCCGFX_GEN_ASSERT_FIELD_ACCESS(val, 0x3UL, __FILE__, __LINE__))
#define GFXREG_CONSTFRAME_CONSTANTCOLORLSBITS_GET_CONSTANTBLUELSBITS(val) (((CYGFX_U32)(val) >> 8U) & 0x3UL)
#define GFXREG_CONSTFRAME_SETM_CONSTANTBLUELSBITS(s,val) ( (s)->constantcolorlsbits = ((s)->constantcolorlsbits & ~0x300UL) | (((CYGFX_U32)(val) << 8U) & 0x300UL) )
#define GFXREG_CONSTFRAME_SET_CONSTANTBLUELSBITS(s,val)  ( (s)->constantcolorlsbits = (((s)->constantcolorlsbits & ~0x300UL) | ((CYGFX_U32)(val) << 8U) ) | GCCGFX_GEN_ASSERT_FIELD_ACCESS(val, 0x3UL, __FILE__, __LINE__) )
#define GFXREG_CONSTFRAME_GET_CONSTANTBLUELSBITS(s) ((((s)->constantcolorlsbits) >> 8U) & 0x3UL)
#define GFXREG_CONSTFRAME_CONSTANTCOLORLSBITS_CONSTANTBLUELSBITS_RESET 0U

/* CONSTANTGREENLSBITS: LSBits of 10-bit green component. */
#define GFXREG_CONSTFRAME_CONSTANTCOLORLSBITS_CONSTANTGREENLSBITS_FSHIFT 16U
#define GFXREG_CONSTFRAME_CONSTANTCOLORLSBITS_CONSTANTGREENLSBITS_FMASK 0x3U
#define GFXREG_CONSTFRAME_CONSTANTCOLORLSBITS_SETM_CONSTANTGREENLSBITS(val) (((CYGFX_U32)(val) & 0x3UL) << 16U)
#define GFXREG_CONSTFRAME_CONSTANTCOLORLSBITS_SET_CONSTANTGREENLSBITS(val) (((CYGFX_U32)(val) << 16U) | GCCGFX_GEN_ASSERT_FIELD_ACCESS(val, 0x3UL, __FILE__, __LINE__))
#define GFXREG_CONSTFRAME_CONSTANTCOLORLSBITS_GET_CONSTANTGREENLSBITS(val) (((CYGFX_U32)(val) >> 16U) & 0x3UL)
#define GFXREG_CONSTFRAME_SETM_CONSTANTGREENLSBITS(s,val) ( (s)->constantcolorlsbits = ((s)->constantcolorlsbits & ~0x30000UL) | (((CYGFX_U32)(val) << 16U) & 0x30000UL) )
#define GFXREG_CONSTFRAME_SET_CONSTANTGREENLSBITS(s,val)  ( (s)->constantcolorlsbits = (((s)->constantcolorlsbits & ~0x30000UL) | ((CYGFX_U32)(val) << 16U) ) | GCCGFX_GEN_ASSERT_FIELD_ACCESS(val, 0x3UL, __FILE__, __LINE__) )
#define GFXREG_CONSTFRAME_GET_CONSTANTGREENLSBITS(s) ((((s)->constantcolorlsbits) >> 16U) & 0x3UL)
#define GFXREG_CONSTFRAME_CONSTANTCOLORLSBITS_CONSTANTGREENLSBITS_RESET 0U

/* CONSTANTREDLSBITS: LSBits of 10-bit red component. */
#define GFXREG_CONSTFRAME_CONSTANTCOLORLSBITS_CONSTANTREDLSBITS_FSHIFT 24U
#define GFXREG_CONSTFRAME_CONSTANTCOLORLSBITS_CONSTANTREDLSBITS_FMASK 0x3U
#define GFXREG_CONSTFRAME_CONSTANTCOLORLSBITS_SETM_CONSTANTREDLSBITS(val) (((CYGFX_U32)(val) & 0x3UL) << 24U)
#define GFXREG_CONSTFRAME_CONSTANTCOLORLSBITS_SET_CONSTANTREDLSBITS(val) (((CYGFX_U32)(val) << 24U) | GCCGFX_GEN_ASSERT_FIELD_ACCESS(val, 0x3UL, __FILE__, __LINE__))
#define GFXREG_CONSTFRAME_CONSTANTCOLORLSBITS_GET_CONSTANTREDLSBITS(val) (((CYGFX_U32)(val) >> 24U) & 0x3UL)
#define GFXREG_CONSTFRAME_SETM_CONSTANTREDLSBITS(s,val) ( (s)->constantcolorlsbits = ((s)->constantcolorlsbits & ~0x3000000UL) | (((CYGFX_U32)(val) << 24U) & 0x3000000UL) )
#define GFXREG_CONSTFRAME_SET_CONSTANTREDLSBITS(s,val)  ( (s)->constantcolorlsbits = (((s)->constantcolorlsbits & ~0x3000000UL) | ((CYGFX_U32)(val) << 24U) ) | GCCGFX_GEN_ASSERT_FIELD_ACCESS(val, 0x3UL, __FILE__, __LINE__) )
#define GFXREG_CONSTFRAME_GET_CONSTANTREDLSBITS(s) ((((s)->constantcolorlsbits) >> 24U) & 0x3UL)
#define GFXREG_CONSTFRAME_CONSTANTCOLORLSBITS_CONSTANTREDLSBITS_RESET 0U

/* CONTROLTRIGGER: ConstFrame unit trigger register */
#define GFXREG_CONSTFRAME_CONTROLTRIGGER 0x00000010U
...
#define GFXREG_CONSTFRAME_START 0x00000014U
...
#define GFXREG_CONSTFRAME_STATUS 0x00000018U
