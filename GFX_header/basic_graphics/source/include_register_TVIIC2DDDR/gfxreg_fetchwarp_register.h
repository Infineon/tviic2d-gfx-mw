...
#define GFXREG_FETCHWARP_BURSTBUFFERMANAGEMENT_CACHEENABLE_FSHIFT 29U
#define GFXREG_FETCHWARP_BURSTBUFFERMANAGEMENT_CACHEENABLE_FMASK 0x1U
#define GFXREG_FETCHWARP_BURSTBUFFERMANAGEMENT_SETM_CACHEENABLE(val) (((CYGFX_U32)(val) & 0x1UL) << 29U)
#define GFXREG_FETCHWARP_BURSTBUFFERMANAGEMENT_SET_CACHEENABLE(val) (((CYGFX_U32)(val) << 29U) | GCCGFX_GEN_ASSERT_FIELD_ACCESS(val, 0x1UL, __FILE__, __LINE__))
#define GFXREG_FETCHWARP_BURSTBUFFERMANAGEMENT_GET_CACHEENABLE(val) (((CYGFX_U32)(val) >> 29U) & 0x1UL)
#define GFXREG_FETCHWARP_SETM_CACHEENABLE(s,val) ( (s)->burstbuffermanagement = ((s)->burstbuffermanagement & ~0x20000000UL) | (((CYGFX_U32)(val) << 29U) & 0x20000000UL) )
#define GFXREG_FETCHWARP_SET_CACHEENABLE(s,val)  ( (s)->burstbuffermanagement = (((s)->burstbuffermanagement & ~0x20000000UL) | ((CYGFX_U32)(val) << 29U) ) | GCCGFX_GEN_ASSERT_FIELD_ACCESS(val, 0x1UL, __FILE__, __LINE__) )
#define GFXREG_FETCHWARP_GET_CACHEENABLE(s) ((((s)->burstbuffermanagement) >> 29U) & 0x1UL)
#define GFXREG_FETCHWARP_BURSTBUFFERMANAGEMENT_CACHEENABLE_RESET 0U

/* ENCACHEINVALIDATION: If enabled (value 1) and if a GfxCache instance is connected to this unit, the cache is invalidated before start of generating a new frame. */
#define GFXREG_FETCHWARP_BURSTBUFFERMANAGEMENT_ENCACHEINVALIDATION_FSHIFT 30U
#define GFXREG_FETCHWARP_BURSTBUFFERMANAGEMENT_ENCACHEINVALIDATION_FMASK 0x1U
#define GFXREG_FETCHWARP_BURSTBUFFERMANAGEMENT_SETM_ENCACHEINVALIDATION(val) (((CYGFX_U32)(val) & 0x1UL) << 30U)
#define GFXREG_FETCHWARP_BURSTBUFFERMANAGEMENT_SET_ENCACHEINVALIDATION(val) (((CYGFX_U32)(val) << 30U) | GCCGFX_GEN_ASSERT_FIELD_ACCESS(val, 0x1UL, __FILE__, __LINE__))
#define GFXREG_FETCHWARP_BURSTBUFFERMANAGEMENT_GET_ENCACHEINVALIDATION(val) (((CYGFX_U32)(val) >> 30U) & 0x1UL)
#define GFXREG_FETCHWARP_SETM_ENCACHEINVALIDATION(s,val) ( (s)->burstbuffermanagement = ((s)->burstbuffermanagement & ~0x40000000UL) | (((CYGFX_U32)(val) << 30U) & 0x40000000UL) )
#define GFXREG_FETCHWARP_SET_ENCACHEINVALIDATION(s,val)  ( (s)->burstbuffermanagement = (((s)->burstbuffermanagement & ~0x40000000UL) | ((CYGFX_U32)(val) << 30U) ) | GCCGFX_GEN_ASSERT_FIELD_ACCESS(val, 0x1UL, __FILE__, __LINE__) )
#define GFXREG_FETCHWARP_GET_ENCACHEINVALIDATION(s) ((((s)->burstbuffermanagement) >> 30U) & 0x1UL)
#define GFXREG_FETCHWARP_BURSTBUFFERMANAGEMENT_ENCACHEINVALIDATION_RESET 0U
