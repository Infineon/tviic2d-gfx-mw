...
/* BURSTTHRESHOLD: When setting a burst threshold larger 0, the generation of output pixels is initially locked. */
#define GFXREG_FRAMECAP_CTR_BURSTTHRESHOLD_FSHIFT 16U
#define GFXREG_FRAMECAP_CTR_BURSTTHRESHOLD_FMASK 0x1ffU
#define GFXREG_FRAMECAP_CTR_SETM_BURSTTHRESHOLD(val) (((CYGFX_U32)(val) & 0x1ffUL) << 16U)
#define GFXREG_FRAMECAP_CTR_SET_BURSTTHRESHOLD(val) (((CYGFX_U32)(val) << 16U) | GCCGFX_GEN_ASSERT_FIELD_ACCESS(val, 0x1ffUL, __FILE__, __LINE__))
#define GFXREG_FRAMECAP_CTR_GET_BURSTTHRESHOLD(val) (((CYGFX_U32)(val) >> 16U) & 0x1ffUL)
#define GFXREG_FRAMECAP_SETM_BURSTTHRESHOLD(s,val) ( (s)->ctr = ((s)->ctr & ~0x1ff0000UL) | (((CYGFX_U32)(val) << 16U) & 0x1ff0000UL) )
#define GFXREG_FRAMECAP_SET_BURSTTHRESHOLD(s,val)  ( (s)->ctr = (((s)->ctr & ~0x1ff0000UL) | ((CYGFX_U32)(val) << 16U) ) | GCCGFX_GEN_ASSERT_FIELD_ACCESS(val, 0x1ffUL, __FILE__, __LINE__) )
#define GFXREG_FRAMECAP_GET_BURSTTHRESHOLD(s) ((((s)->ctr) >> 16U) & 0x1ffUL)
#define GFXREG_FRAMECAP_CTR_BURSTTHRESHOLD_RESET 0U
