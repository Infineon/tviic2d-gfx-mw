...
/** subss_gfxcachepix (see gccgfx_gfxcache4_register.h) */
#define GFXREG_SUBSS_GFXCACHEPIX_BASE      (CYGFX_VIDEOSS_BASE + 0x00000800U)

/** subss_gfxcachecmd (see gccgfx_gfxcache1_register.h) */
#define GFXREG_SUBSS_GFXCACHECMD_BASE      (CYGFX_VIDEOSS_BASE + 0x00000c00U)

/** subss_lbcbarblit (see gccgfx_lbcbar3_register.h) */
#define GFXREG_SUBSS_LBCBARBLIT_BASE      (CYGFX_VIDEOSS_BASE + 0x00001000U)

/** subss_lbcbarjpgcmd (see gccgfx_lbcbarl3_register.h) */
#define GFXREG_SUBSS_LBCBARJPGCMD_BASE      (CYGFX_VIDEOSS_BASE + 0x00001400U)

/** subss_lbcbarvideo0 (see gccgfx_lbcbarl3_register.h) */
#define GFXREG_SUBSS_LBCBARVIDEO0_BASE      (CYGFX_VIDEOSS_BASE + 0x00001800U)

/** subss_lbcbarvideo1 (see gccgfx_lbcbarl3_register.h) */
#define GFXREG_SUBSS_LBCBARVIDEO1_BASE      (CYGFX_VIDEOSS_BASE + 0x00001c00U)
...
/** videoio_diseng0_histogram (see gccgfx_histogram_register.h) */
#define GFXREG_VIDEOIO_DISENG0_HISTOGRAM_BASE      (CYGFX_VIDEOSS_BASE + 0x000a1400U)

/** videoio_diseng0_gammacor2 (see gccgfx_gammacor_register.h) */
#define GFXREG_VIDEOIO_DISENG0_GAMMACOR2_BASE      (CYGFX_VIDEOSS_BASE + 0x000a1800U)

/** videoio_diseng0_matrix (see gccgfx_matrix_register.h) */
#define GFXREG_VIDEOIO_DISENG0_MATRIX_BASE      (CYGFX_VIDEOSS_BASE + 0x000a1c00U)
...
/** videoio_diseng1_histogram (see gccgfx_histogram_register.h) */
#define GFXREG_VIDEOIO_DISENG1_HISTOGRAM_BASE      (CYGFX_VIDEOSS_BASE + 0x000a5400U)

/** videoio_diseng1_gammacor2 (see gccgfx_gammacor_register.h) */
#define GFXREG_VIDEOIO_DISENG1_GAMMACOR2_BASE      (CYGFX_VIDEOSS_BASE + 0x000a5800U)

/** videoio_diseng1_matrix (see gccgfx_matrix_register.h) */
#define GFXREG_VIDEOIO_DISENG1_MATRIX_BASE      (CYGFX_VIDEOSS_BASE + 0x000a5c00U)
...
/** infra_vrpu (see gccgfx_vrpu_register.h) */
#define GFXREG_INFRA_VRPU_BASE      (CYGFX_VIDEOSS_BASE + 0x000f0000U)

/** infra_gfx_mpu_rd0 (see gccgfx_gfx_mpu_rd_register.h) */
#define GFXREG_INFRA_GFX_MPU_RD0_BASE      (CYGFX_VIDEOSS_BASE + 0x000f4000U)

/** infra_gfx_mpu_rd1 (see gccgfx_gfx_mpu_rd_register.h) */
#define GFXREG_INFRA_GFX_MPU_RD1_BASE      (CYGFX_VIDEOSS_BASE + 0x000f4400U)

/** infra_gfx_mpu_rd2 (see gccgfx_gfx_mpu_rd_register.h) */
#define GFXREG_INFRA_GFX_MPU_RD2_BASE      (CYGFX_VIDEOSS_BASE + 0x000f4800U)

/** infra_gfx_mpu_rd3 (see gccgfx_gfx_mpu_rd_register.h) */
#define GFXREG_INFRA_GFX_MPU_RD3_BASE      (CYGFX_VIDEOSS_BASE + 0x000f4c00U)

/** infra_gfx_mpu_rd4 (see gccgfx_gfx_mpu_rd_register.h) */
#define GFXREG_INFRA_GFX_MPU_RD4_BASE      (CYGFX_VIDEOSS_BASE + 0x000f5000U)

/** infra_gfx_mpu_rd5 (see gccgfx_gfx_mpu_rd_register.h) */
#define GFXREG_INFRA_GFX_MPU_RD5_BASE      (CYGFX_VIDEOSS_BASE + 0x000f5400U)

/** infra_gfx_mpu_rd6 (see gccgfx_gfx_mpu_rd_register.h) */
#define GFXREG_INFRA_GFX_MPU_RD6_BASE      (CYGFX_VIDEOSS_BASE + 0x000f5800U)

/** infra_gfx_mpu_rd7 (see gccgfx_gfx_mpu_rd_register.h) */
#define GFXREG_INFRA_GFX_MPU_RD7_BASE      (CYGFX_VIDEOSS_BASE + 0x000f5c00U)

/** infra_gfx_mpu_rd8 (see gccgfx_gfx_mpu_rd_register.h) */
#define GFXREG_INFRA_GFX_MPU_RD8_BASE      (CYGFX_VIDEOSS_BASE + 0x000f6000U)

/** infra_gfx_mpu_rd9 (see gccgfx_gfx_mpu_rd_register.h) */
#define GFXREG_INFRA_GFX_MPU_RD9_BASE      (CYGFX_VIDEOSS_BASE + 0x000f6400U)

/** infra_gfx_mpu_rd10 (see gccgfx_gfx_mpu_rd_register.h) */
#define GFXREG_INFRA_GFX_MPU_RD10_BASE      (CYGFX_VIDEOSS_BASE + 0x000f6800U)

/** infra_gfx_mpu_rd11 (see gccgfx_gfx_mpu_rd_register.h) */
#define GFXREG_INFRA_GFX_MPU_RD11_BASE      (CYGFX_VIDEOSS_BASE + 0x000f6c00U)

/** infra_gfx_mpu_rd12 (see gccgfx_gfx_mpu_rd_register.h) */
#define GFXREG_INFRA_GFX_MPU_RD12_BASE      (CYGFX_VIDEOSS_BASE + 0x000f7000U)

/** infra_gfx_mpu_rd13 (see gccgfx_gfx_mpu_rd_register.h) */
#define GFXREG_INFRA_GFX_MPU_RD13_BASE      (CYGFX_VIDEOSS_BASE + 0x000f7400U)

/** infra_gfx_mpu_rd14 (see gccgfx_gfx_mpu_rd_register.h) */
#define GFXREG_INFRA_GFX_MPU_RD14_BASE      (CYGFX_VIDEOSS_BASE + 0x000f7800U)

/** infra_gfx_mpu_rd15 (see gccgfx_gfx_mpu_rd_register.h) */
#define GFXREG_INFRA_GFX_MPU_RD15_BASE      (CYGFX_VIDEOSS_BASE + 0x000f7c00U)

/** infra_gfx_mpu_wr0 (see gccgfx_gfx_mpu_wr_register.h) */
#define GFXREG_INFRA_GFX_MPU_WR0_BASE      (CYGFX_VIDEOSS_BASE + 0x000f8000U)

/** infra_gfx_mpu_wr1 (see gccgfx_gfx_mpu_wr_register.h) */
#define GFXREG_INFRA_GFX_MPU_WR1_BASE      (CYGFX_VIDEOSS_BASE + 0x000f8400U)

/** infra_gfx_mpu_wr2 (see gccgfx_gfx_mpu_wr_register.h) */
#define GFXREG_INFRA_GFX_MPU_WR2_BASE      (CYGFX_VIDEOSS_BASE + 0x000f8800U)

/** infra_gfx_mpu_wr3 (see gccgfx_gfx_mpu_wr_register.h) */
#define GFXREG_INFRA_GFX_MPU_WR3_BASE      (CYGFX_VIDEOSS_BASE + 0x000f8c00U)

/** infra_gfx_mpu_wr4 (see gccgfx_gfx_mpu_wr_register.h) */
#define GFXREG_INFRA_GFX_MPU_WR4_BASE      (CYGFX_VIDEOSS_BASE + 0x000f9000U)

/** infra_gfx_mpu_wr5 (see gccgfx_gfx_mpu_wr_register.h) */
#define GFXREG_INFRA_GFX_MPU_WR5_BASE      (CYGFX_VIDEOSS_BASE + 0x000f9400U)

/** infra_gfx_mpu_wr6 (see gccgfx_gfx_mpu_wr_register.h) */
#define GFXREG_INFRA_GFX_MPU_WR6_BASE      (CYGFX_VIDEOSS_BASE + 0x000f9800U)

/** infra_gfx_mpu_wr7 (see gccgfx_gfx_mpu_wr_register.h) */
#define GFXREG_INFRA_GFX_MPU_WR7_BASE      (CYGFX_VIDEOSS_BASE + 0x000f9c00U)

/** infra_gfx_mpu_wr8 (see gccgfx_gfx_mpu_wr_register.h) */
#define GFXREG_INFRA_GFX_MPU_WR8_BASE      (CYGFX_VIDEOSS_BASE + 0x000fa000U)

/** infra_gfx_mpu_wr9 (see gccgfx_gfx_mpu_wr_register.h) */
#define GFXREG_INFRA_GFX_MPU_WR9_BASE      (CYGFX_VIDEOSS_BASE + 0x000fa400U)

/** infra_gfx_mpu_wr10 (see gccgfx_gfx_mpu_wr_register.h) */
#define GFXREG_INFRA_GFX_MPU_WR10_BASE      (CYGFX_VIDEOSS_BASE + 0x000fa800U)

/** infra_gfx_mpu_wr11 (see gccgfx_gfx_mpu_wr_register.h) */
#define GFXREG_INFRA_GFX_MPU_WR11_BASE      (CYGFX_VIDEOSS_BASE + 0x000fac00U)

/** infra_gfx_mpu_wr12 (see gccgfx_gfx_mpu_wr_register.h) */
#define GFXREG_INFRA_GFX_MPU_WR12_BASE      (CYGFX_VIDEOSS_BASE + 0x000fb000U)

/** infra_gfx_mpu_wr13 (see gccgfx_gfx_mpu_wr_register.h) */
#define GFXREG_INFRA_GFX_MPU_WR13_BASE      (CYGFX_VIDEOSS_BASE + 0x000fb400U)

/** infra_gfx_mpu_wr14 (see gccgfx_gfx_mpu_wr_register.h) */
#define GFXREG_INFRA_GFX_MPU_WR14_BASE      (CYGFX_VIDEOSS_BASE + 0x000fb800U)

/** infra_gfx_mpu_wr15 (see gccgfx_gfx_mpu_wr_register.h) */
#define GFXREG_INFRA_GFX_MPU_WR15_BASE      (CYGFX_VIDEOSS_BASE + 0x000fbc00U)
